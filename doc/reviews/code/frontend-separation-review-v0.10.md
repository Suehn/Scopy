...
- 当前实现基线：v0.9.4（doc/implementation/README.md），本次改动标记：v0.10 前后端分离强化。
- 评审范围：协议/服务/AppState/Settings/HistoryList 解耦改动；前后端分离与前端迁移可行性；相关测试/Mock。
- 评审依据：AGENTS.md、CLAUDE.md、doc/specs/v0.md、doc/reviews/frontend-separation-review.md（2024-11-28）、现有实现索引。
...
## 现状对照（doc/specs/v0.md & frontend-separation-review.md）
...
- 文档：新增 doc/reviews/frontend-separation-review.md（详述 Phase 1-4），本评审补充 doc/reviews/frontend-separation-review-v0.10.md。
