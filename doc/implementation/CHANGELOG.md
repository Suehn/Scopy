...
- **Observables**：HistoryViewModel 任务取消/过滤判断收敛；PerformanceMetrics 延迟格式化统一。
- **Docs**：新增优雅性深度 review 文档。
- **版本说明**：由于远端 `v0.50.fix3` tag 已存在，本次以 `v0.50.fix4` 重新发布（内容一致）。
...
- **自动打 tag（可选）**：推送到 `main` 且更新实现文档后，从 `doc/implementation/README.md` 解析 **当前版本** 并自动打 tag，触发 Release workflow。
...
- `DEPLOYMENT.md`
- `doc/profiles/v0.43.9-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.43.9.md`
...
- `Scopy/Views/History/HistoryItemTextPreviewView.swift`
- `DEPLOYMENT.md`
- `doc/profiles/v0.43.8-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.43.8.md`
- `doc/implementation/README.md`
- `doc/implementation/CHANGELOG.md`
- `doc/reviews/review-v0.3.md`
...
- `ScopyTests/ClipboardMonitorTests.swift`
- `DEPLOYMENT.md`
- `doc/profiles/v0.43.7-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.43.7.md`
- `doc/implementation/README.md`
- `doc/implementation/CHANGELOG.md`
- `doc/reviews/review-v0.3.md`
...
- `Scopy/Views/History/HistoryItemView.swift`
- `DEPLOYMENT.md`
- `doc/profiles/v0.43.6-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.43.6.md`
- `doc/implementation/README.md`
- `doc/implementation/CHANGELOG.md`
- `doc/reviews/review-v0.3.md`
...
- `Scopy/Application/ClipboardService.swift`
- `DEPLOYMENT.md`
- `doc/profiles/v0.43.5-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.43.5.md`
- `doc/implementation/README.md`
- `doc/implementation/CHANGELOG.md`
- `doc/reviews/review-v0.3.md`
...
- `Scopy/Views/History/HistoryItemView.swift`
- `DEPLOYMENT.md`
- `doc/profiles/v0.43.4-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.43.4.md`
- `doc/implementation/README.md`
- `doc/implementation/CHANGELOG.md`
- `doc/reviews/review-v0.3.md`
...
- `ScopyTests/SearchServiceTests.swift`
- `DEPLOYMENT.md`
- `doc/profiles/v0.43.3-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.43.3.md`
- `doc/implementation/README.md`
- `doc/implementation/CHANGELOG.md`
- `doc/reviews/review-v0.3.md`
...
- `Scopy.xcodeproj/project.pbxproj`
- `DEPLOYMENT.md`
- `doc/profiles/v0.43.2-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.43.2.md`
- `doc/implementation/README.md`
- `doc/implementation/CHANGELOG.md`
- `doc/reviews/review-v0.3.md`
...
- `ScopyTests/*`
- `DEPLOYMENT.md`
- `doc/profiles/v0.43.1-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.43.1.md`
- `doc/implementation/README.md`
- `doc/implementation/CHANGELOG.md`
- `doc/reviews/review-v0.3.md`
...
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.43.md`
- `doc/implementation/README.md`
- `doc/reviews/review-v0.3.md`
...
- **日志便于审计**：输出写入 `logs/strict-concurrency-test.log`，便于 CI/本地排查隔离回归。

### 修改文件

- `Makefile`
- `DEPLOYMENT.md`
- `doc/profiles/v0.41-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.41.md`
- `doc/implementation/README.md`
- `doc/reviews/review-v0.3.md`
...
- `ScopyTests/PerformanceTests.swift`
- `DEPLOYMENT.md`
- `doc/profiles/v0.40-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.40.md`
- `doc/implementation/README.md`
- `doc/reviews/review-v0.3.md`
...
- **日志文件不入库**：忽略 `logs/build.log` 与 `logs/strict-concurrency-*.log`。
...
- `ScopyUITests/*`
- `DEPLOYMENT.md`
- `doc/profiles/v0.39-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.39.md`
- `doc/implementation/README.md`
- `doc/reviews/review-v0.3.md`
...
- `Scopy.xcodeproj/project.pbxproj`
- `DEPLOYMENT.md`
- `doc/profiles/v0.38-profile.md`
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.38.md`
- `doc/implementation/README.md`
- `doc/reviews/review-v0.3.md`
...
- `doc/profiles/README.md`
- `doc/implementation/releases/v0.37.md`
- `doc/implementation/README.md`
- `doc/reviews/review-v0.3.md`
...
- `doc/implementation/releases/v0.36.1.md`
- `doc/implementation/README.md`
- `doc/reviews/review-v0.3.md`
...
- `Scopy/Services/HotKeyService.swift`
- `Scopy.xcodeproj/project.pbxproj`
- `doc/implementation/releases/v0.36.md`
- `doc/profiles/v0.36-profile.md`
...
- **review SSOT 更新**：`doc/reviews/review-v0.3.md` 的基线与阶段状态对齐到 v0.35

### 修改文件
- `DEPLOYMENT.md`
- `doc/implementation/README.md`
- `doc/implementation/CHANGELOG.md`
- `doc/implementation/releases/v0.35.1.md`
- `doc/profiles/README.md`
- `doc/profiles/v0.35.1-profile.md`
- `doc/reviews/review-v0.3.md`
...
- `Scopy/Views/HistoryListView.swift`
- `Scopy/Views/History/*`
- `doc/implementation/releases/v0.35.md`
- `doc/profiles/v0.35-profile.md`
...
- `Scopy/Observables/AppState.swift`
- `ScopyTests/PerformanceTests.swift`
- `doc/implementation/releases/v0.34.md`
- `doc/profiles/v0.34-profile.md`
...
- `doc/implementation/releases/v0.33.md`
- `doc/profiles/v0.33-profile.md`
...
- `Scopy/Services/RealClipboardService.swift`
- `ScopyTests/*`
- `doc/implementation/releases/v0.32.md`
- `doc/profiles/v0.32-profile.md`
...
- `doc/implementation/releases/v0.31.md`
...
- `Scopy/AppDelegate.swift`
- `Scopy/Services/RealClipboardService.swift`
- `doc/implementation/releases/v0.30.md`
...
- `Scopy/Views/HistoryListView.swift`
- `ScopyTests/*`
- `doc/implementation/releases/v0.29.md`
...
- `Scopy/Views/HistoryListView.swift`
- `ScopyTests/SearchServiceTests.swift`
- `doc/implementation/releases/v0.28.md`
...
- `doc/implementation/releases/v0.27.md`
...
- `Scopy/Services/SearchService.swift`
- `ScopyTests/PerformanceTests.swift`
- `doc/implementation/releases/v0.26.md`
...
- **超深度全仓库 Review 文档** - 覆盖 v0.md 规格对齐、性能/稳定性/安全审查与后续行动清单
  - **新增** - `doc/implementation/releases/v0.24.md`

### 修改文件
- `Scopy/Views/HistoryListView.swift` - Hover 预览稳定性修复
- `doc/implementation/releases/v0.24.md` - 超深度 Review 文档
- `doc/implementation/README.md` - 更新版本索引
- `doc/implementation/CHANGELOG.md` - 更新变更记录
...
> **里程碑**: 基于 `doc/reviews/rustling-gathering-quill.md` 的系统性修复工作已完成
> - P0 严重问题: 4/4 ✅
...
基于 `doc/reviews/rustling-gathering-quill.md` 审查报告的系统性修复。
...
- 性能测试：已运行，详见 `doc/profiles/v0.16-profile.md`（搜索/清理/内存等指标）。
