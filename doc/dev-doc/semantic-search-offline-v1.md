...
更新日期：2025-12-17  
当前代码基线：`v0.44.fix20`（见 `doc/implemented-doc/README.md`）  
文档性质：**开发设计文档（未实现）**  
...
以 v0.md 的“10k–100k：首屏 100–150ms”目标为基线（参考 `doc/dev-doc/v0.md` 与 `ScopyTests/PerformanceTests.swift`）。
...
- 若性能/部署变化，按仓库规范补齐 `doc/profile/vX.Y-profile.md`（实现后做）
