...
- ✅ `make test-unit`
- ✅ `make test-tsan`
- ⏳ `/tmp/scopy_hotkey.log`（本版本无热键代码改动；按 `doc/reviews/review-v0.3.md` 仍建议人工自查一次）

---

## 遗留与后续

- Thread Sanitizer 已可跑通；Strict Concurrency 建议继续按 `doc/reviews/review-v0.3.md` 渐进开启（先从 tests target 开始）。
