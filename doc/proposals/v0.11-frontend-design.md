...
> 目标：以 macOS 原生风格重塑历史剪贴板主界面与 Settings，高度可自定义、前后端彻底解耦，保持现有性能与安全基线（参考 `doc/specs/v0.md`、`doc/reviews/frontend-separation-review.md`）。
...
- 现有性能与分层规范：`doc/specs/v0.md`、`doc/reviews/frontend-separation-review.md`、`doc/reviews/frontend-separation-review-v0.10.md`。
