...
- Hover previews have a subtle corner resize grip. A single quiet toolbar occupies its own space above the content; controls brighten on hover without covering the first paragraph.
