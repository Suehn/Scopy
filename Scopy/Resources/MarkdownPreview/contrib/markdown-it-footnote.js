// Vendored from markdown-it-footnote (MIT).
// Source: https://github.com/markdown-it/markdown-it-footnote/blob/master/index.mjs
...
function footnote_plugin (md) {
  ...
  window.markdownitFootnote = footnote_plugin;
})();
