...
- Search-field focus and visible row selection are independent. Do not clear selectedID only because the search field gains focus, and keep hover-driven selection available while the field is focused.
