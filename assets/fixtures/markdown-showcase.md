...
这是一个段落，其中包含自动链接：https://example.com，邮箱：user@example.com，以及一个带标题的链接：[OpenAI](https://openai.com)。

这是一个参考式链接：[参考链接](https://example.com)，也是一个参考式图片：



![内联图片](https://example.com/image.png)
...
这是转义字符示例：\*不是斜体\*、\#不是标题、\$不是链接文本\$、\`不是代码\`
