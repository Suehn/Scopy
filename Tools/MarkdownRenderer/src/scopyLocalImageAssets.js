...
const CITATION_FAVICON_HOSTS = Object.freeze({
...
export function bundledFaviconAssetForCitationHost(host) {
  return typeof host === "string" && Object.hasOwn(CITATION_FAVICON_HOSTS, host)
    ? CITATION_FAVICON_HOSTS[host]
    : null;
}
