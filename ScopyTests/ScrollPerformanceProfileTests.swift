...
@MainActor
/// Tests the scroll profiler instrumentation itself (`ScrollPerformanceProfile`), not the list's scroll performance.
final class ScrollPerformanceProfileTests: XCTestCase {
