...
- `markdown_site_icons_neosoul.md`: complete user-supplied 2026-09-11 report for arbitrary-site inline favicon verification; claims are fixture text, not research performed by Scopy.
