...
_FALLBACK_BREADCRUMBS = {
    "no_task": (
        ...
        "`TASK_DIR=<task-dir>`, treat that directory as the active task, "
        "verify `<task-dir>/prd.md`, and proceed; do not create a new task "
        "or ask the parent to restate it solely because this isolated session "
        "has no active pointer.\n"
