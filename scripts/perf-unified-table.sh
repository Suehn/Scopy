...
frontend_metric_specs = [
    ...
    ("frontend.active_frame.p95_ms", ("active_frame_p95_ms", "median"), "ms"),
    ("frontend.active_frame.max_ms", ("active_frame_max_ms", "median"), "ms"),
    ("frontend.process.cpu_seconds", ("process_cpu_seconds", "median"), "s"),
    ("frontend.main_runloop_active.total_ms", ("main_runloop_active_total_ms", "median"), "ms"),
    ("frontend.active_drop_ratio", ("active_drop_ratio", "median"), "ratio"),
    ("frontend.main_runloop_active.p95_ms", ("main_runloop_active_p95_ms", "median"), "ms"),
    ("frontend.long_frame.count", ("long_frame_attribution", "long_frame_count"), "count"),
    ("frontend.long_frame.attributed_union_ms", ("long_frame_attribution", "attributed_union_ms"), "ms"),
    ("frontend.long_frame.unattributed_ms", ("long_frame_attribution", "unattributed_ms"), "ms"),
    ("frontend.long_frame.coverage_ratio", ("long_frame_attribution", "attribution_coverage_ratio"), "ratio"),
    ("frontend.main_thread_long_frame.coverage_ratio", ("main_thread_long_frame_attribution", "attribution_coverage_ratio"), "ratio"),
    ("frontend.swiftui.row_body.p95_ms", ("bucket_p95_ms", "swiftui.row_body_ms", "median"), "ms"),
    ("frontend.swiftui.row_equatable.p95_ms", ("bucket_p95_ms", "swiftui.row_equatable_ms", "median"), "ms"),
    ("frontend.row.display_model.p95_ms", ("bucket_p95_ms", "row.display_model_ms", "median"), "ms"),
    ("frontend.row.file_preview.p95_ms", ("bucket_p95_ms", "row.file_preview_ms", "median"), "ms"),
    ("frontend.accessibility.snapshot_ms", ("accessibility_snapshot_ms", "median"), "ms"),
    ("frontend.accessibility.ax_query_ms", ("accessibility_ax_query_ms", "median"), "ms"),
    ("frontend.accessibility.ax_children_count", ("accessibility_ax_children_count", "median"), "count"),
    ("frontend.accessibility.ax_rows_count", ("accessibility_ax_rows_count", "median"), "count"),
    ("frontend.accessibility.view_count", ("accessibility_view_count", "median"), "count"),
    ("frontend.xctest.history_item_query_ms", ("xctest_history_item_query_ms", "median"), "ms"),
    ("frontend.xctest.history_item_count", ("xctest_history_item_count", "median"), "count"),
    ("frontend.text.metadata.p95_ms", ("bucket_p95_ms", "text.metadata_ms", "median"), "ms"),
    ("frontend.text.markdown_detect.p95_ms", ("bucket_p95_ms", "text.markdown_detect_ms", "median"), "ms"),
    ("frontend.image.thumbnail_decode.p95_ms", ("bucket_p95_ms", "image.thumbnail_decode_ms", "median"), "ms"),
    ("frontend.image.thumbnail_queue_wait.p95_ms", ("bucket_p95_ms", "image.thumbnail_queue_wait_ms", "median"), "ms"),
    ("frontend.image.thumbnail_imageio_decode.p95_ms", ("bucket_p95_ms", "image.thumbnail_imageio_decode_ms", "median"), "ms"),
    ("frontend.image.thumbnail_main_commit.p95_ms", ("bucket_p95_ms", "image.thumbnail_main_commit_ms", "median"), "ms"),
    ("frontend.image.thumbnail_load_total.p95_ms", ("bucket_p95_ms", "image.thumbnail_load_total_ms", "median"), "ms"),
]
